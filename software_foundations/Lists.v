...
Example test_subset0: subset [1] [1;2] = true.
  reflexivity. Qed.
...
Theorem app_nil_end : forall l : natlist, 
  l ++ [] = l.   
Proof.
  intros l. induction l. reflexivity.
  simpl.  rewrite -> IHl. reflexivity. Qed.

Theorem rev_snoc_cons : forall l : natlist, forall n : nat,
...
Proof.
  intros l. induction l. reflexivity.
  simpl. rewrite -> rev_snoc_cons. rewrite -> IHl. reflexivity. Qed. 
...
Proof.
  intros l1 l2. induction l1. 
    simpl. SearchAbout app. rewrite -> app_nil_end. reflexivity.
  simpl. SearchAbout app. rewrite -> snoc_append. rewrite -> snoc_append.
    rewrite -> IHl1. rewrite -> app_assoc. reflexivity. Qed.
...
Proof.
  intros l1 l2. induction l1. simpl. reflexivity.
  simpl. rewrite -> IHl1. destruct (beq_nat n 0). reflexivity. reflexivity. Qed.
(** [] *)
...
Fixpoint beq_natlist (l1 l2 : natlist) : bool :=
  ...
  | h1 :: t1 => match l2 with
           | nil => false
           | h2 :: t2 => andb (beq_natlist t1 t2) (beq_nat h1 h2)
           end
  end.
...
Theorem beq_nat_refl : forall n:nat,
  true = beq_nat n n.
Proof. intros n. induction n. reflexivity. 
  simpl. rewrite <- IHn. reflexivity. Qed.

Theorem beq_natlist_refl : forall l:natlist,
  true = beq_natlist l l.
Proof. intros l. induction l. reflexivity. 
...
Proof.
  intros s. induction s as [| n s']. reflexivity.
  Case "n :: s'".
    simpl. induction n as [| n']. simpl. rewrite -> ble_n_Sn. reflexivity.
...
Proof.
  intros l default. induction l. simpl. reflexivity.
...
Proof.
  intros d k v. simpl. rewrite neq. reflexivity. Qed.
