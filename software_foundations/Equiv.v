...
(* diverge  *) [prog_a;prog_d;prog_f;prog_g];
(* identity *) [prog_b;prog_c;prog_h];
(* y is 0   *) [prog_e];
(* other    *) [prog_i] ].
...
Theorem IFB_false: forall b c1 c2,
  ...
  cequiv 
    ...
    c2.
Proof.
  intros b c1 c2 Hb. unfold bequiv in Hb. split; intros H.
    inversion H. subst.
...
Proof.
  intros b e1 e2. split; intros H.
    ...
    SearchAbout negb.
    inversion H; subst.
      apply E_IfFalse. simpl in H5. symmetry in H5. apply negb_sym in H5. 
        assumption. assumption.
      apply E_IfTrue. simpl in H5. symmetry in H5. apply negb_sym in H5.
        assumption. assumption.
Qed.
...
Proof. 
  intros b c Hb. split; intros H; apply WHILE_true_nonterm in H.
    inversion H. assumption.
    inversion H. unfold bequiv; reflexivity.
Qed.
