...
Theorem rev_exercise1 : forall (l l' : list nat),
     ...
     l' = rev l.
Proof. intros l l' H.
  SearchAbout rev. rewrite H. symmetry. apply rev_involutive. Qed.
(** [] *)
...
Proof. intros. symmetry in H. destruct n. reflexivity. inversion H. Qed.
...
Proof.
  intros n. induction n.
  Case "n=0". intros. destruct m. reflexivity. inversion H.
  Case "n=S n'". intros. destruct m. inversion H.
    apply f_equal. apply IHn. inversion H. reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  induction l1. 
    intros. simpl. destruct n.
      inversion H. rewrite <- H. simpl. reflexivity.
    intros. destruct n.
      inversion H.
...
Theorem app_length_cons_inv : forall (X : Type) (l1 l2 : list X) 
                                  (x : X) (n : nat),
     S (length (l1 ++ l2)) = n ->
     length (l1 ++ (x :: l2)) = n.
Proof.
  intros X l1. induction l1.
    ...
    intros. simpl. destruct n.
      inversion H.
      apply f_equal. apply IHl1. inversion H. reflexivity. Qed.
...
Proof.
  intros. generalize dependent n. induction l as [|h t].
    intros. simpl. destruct n. reflexivity. inversion H.
    intros. simpl. destruct n.
      inversion H. rewrite <- plus_n_Sm.
      simpl. apply f_equal. simpl in H. apply app_length_cons_inv.
      apply f_equal. apply IHt. inversion H. reflexivity. Qed.
(** [] *)
...
Theorem combine_split : forall X Y (l : list (X * Y)) l1 l2,
  ...
  combine l1 l2 = l.
Proof.
  intros X Y l. induction l as [| xy l']. 
    intros. simpl in H. inversion H. reflexivity.
    intros l1 l2. simpl. destruct xy. destruct (split l').
      destruct l1 as [|x' l1'].
        destruct l2 as [|y' l2'].
        ...
        destruct l2 as [|y' l2'].
          intros. inversion H.
          simpl. intros. rewrite IHl'. inversion H. reflexivity.
...
Theorem bool_fn_applied_thrice : 
  ...
  f (f (f b)) = f b.
Proof.
  intros. destruct (f b) eqn:fb. destruct b eqn:Hb.
    rewrite fb. apply fb.
    destruct (f true) eqn:ft. apply ft. apply fb.
    destruct b. destruct (f false) eqn:ff. apply fb. apply ff.
    rewrite fb. apply fb. Qed.
(** [] *)
...
Proof.
  intros. unfold override. destruct (beq_nat k1 k2) eqn:eqk1k2.
    apply beq_nat_true in eqk1k2. rewrite <- eqk1k2. symmetry. apply H.
    reflexivity. Qed.
(** [] *)
...
Theorem pair_cons_eq : forall X Y (a : X) (c : Y) b d b' d',
  (b,d)=(b',d') -> (a::b,c::d) = (a::b',c::d').
Proof. intros. inversion H. reflexivity. Qed.


Theorem split_combine : split_combine_statement.
Proof. unfold split_combine_statement.
  intros X Y l. induction l as [|xy l'].
    intros. simpl. destruct l1 as [|x l1'].
      destruct l2 as [|y l2'].
        reflexivity. simpl in H. inversion H.
      destruct l2 as [|y l2'].
        inversion H. inversion H0.
    intros. simpl. destruct xy. destruct (split l').
      destruct l1 as [|x' l1'].
        destruct l2 as [|y' l2']. 
          inversion H0.
          inversion H.
        destruct l2 as [|y' l2']. 
          inversion H.
          inversion H0. apply pair_cons_eq.
          apply IHl'. simpl in H. inversion H. reflexivity.
          apply H4. Qed.
...
Proof.
  intros. unfold override.
    destruct (beq_nat k1 k3) eqn:eq13. 
      apply beq_nat_true in eq13. rewrite <- eq13. rewrite H. reflexivity.
      reflexivity. Qed.
(** [] *)
...
Theorem filter_exercise : forall (X : Type) (test : X -> bool)
     ...
     test x = true.
Proof.
  intros X test x l. generalize dependent x. generalize dependent test.
  induction l as [|h l'].
    Case "[]". intros. inversion H.
    Case "h::l'". intros.
      simpl in H. destruct (test h) eqn:testh.
        inversion H. rewrite <- H1. apply testh.
        apply IHl' with (lf:=lf). apply H. Qed.
(** [] *)
